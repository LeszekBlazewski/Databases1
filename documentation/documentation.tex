...
\subsubsubsection{Operacja dodawania rekordów}
...
\begin{figure}[h!]
\centering
\subfloat[Wynik zapytania z danymi klientów]{{\includegraphics[scale=2.5]{clients.png}}}
\qquad
\subfloat[Wynik zapytania z danymi basenów]{{\includegraphics[scale=2.5]{pools.png}}}
...
\begin{figure}[h!]
\centering
\includegraphics[scale=2.5]{reservation_error.png}
...
\begin{figure}[h!]
\centering
\includegraphics[scale=2.5]{reservations_error_n.png}
\caption{Wywołanie wyjątku triggera podczas próby wstawienia błędnej rezerwacji}
\end{figure}
...
\subsubsubsection{Operacja selekcji wybranych danych}
...
\subsubsubsection{Operacja aktualizacji wybranych rekordów}
